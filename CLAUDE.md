...
**Último commit:** `0ccbae6` (fix GAP delivered→completed + tooling de simulación). Sin commit nuevo en 2026-06-23 (solo validación + docs CHANGELOG/§12). `origin/main` al día; Vercel despliega por push a main.
