...
export default async function OperatorCyclePage() {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl font-bold text-miski-forest mb-2">Ciclo de despacho</h1>
      ...
      {!cycles || cycles.length === 0 ? (
        <p className="text-sm text-miski-muted">No hay ciclos activos en este momento.</p>
      ) : (
        <div className="space-y-4 max-w-lg">
          <div className="text-xs text-miski-muted mb-1 px-1">
