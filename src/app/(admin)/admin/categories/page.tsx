  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-display text-2xl font-bold text-miski-forest">Categorías</h1>
        <Link
      ...
      {!categories?.length ? (
        <p className="text-miski-muted text-sm">No hay categorías aún.</p>
      ) : (
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-medium text-miski-tinta">Slug</th>
                <th className="text-right px-4 py-3 font-medium text-miski-tinta">Costo op. %</th>
                <th className="text-right px-4 py-3 font-medium text-miski-tinta">Margen %</th>
                <th className="text-right px-4 py-3 font-medium text-miski-tinta">Merma %</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {categories.map(cat => (
                <tr key={cat.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-miski-muted font-mono text-xs">{cat.slug}</td>
                  <td className="px-4 py-3 text-right text-miski-tinta">
