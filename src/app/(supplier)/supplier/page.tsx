    ...
    <div>
      <div className="mb-6">
        ...
        <div className="mt-2 flex items-center gap-2">
          <span className="text-xs text-miski-muted">Confiabilidad:</span>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8 sm:grid-cols-4">
        {(Object.keys(STATUS_LABEL) as (keyof typeof counts)[]).map(status => (
          <div key={status} className="bg-white rounded-xl border border-miski-border shadow-sm p-5">
            <p className="text-xs font-medium text-miski-muted uppercase tracking-wide">
              {STATUS_LABEL[status]}
            </p>
